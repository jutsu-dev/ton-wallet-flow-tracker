...
<sub>Оба изображения сняты в демо-режиме. Все адреса, суммы и метки на них синтетические.</sub>
...
У каждого документа есть английский оригинал в файле без суффикса `.ru`. Пользовательское руководство внутри приложения доступно по адресу `/docs` на русском и английском.
